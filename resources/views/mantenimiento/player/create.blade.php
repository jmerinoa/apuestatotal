    ...
    <div class="modal-dialog ">
        <div class="modal-content">
            <div class="modal-header bg-dark">
                <h4 class="modal-title text-white" id="formModalLabel">Crear Player</h4>
                <button type="button" class="close text-white" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            {!! Form::open(['url' => 'mantenimiento/player', 'method' => 'POST', 'autocomplete' => 'off', 'files' => 'true']) !!}
            {!! Form::token() !!}
            <div class="modal-body">
                    <div class="form-group">
                        ...
                        <div class="input-group a mb-3">
                            ...
                            <input type="text" class="form-control fi"  name="nomPlayer"
                                placeholder="Ingrese nombre" autocomplete="off" value="{{ old('nomPlayer') }}" required>
                        </div>
